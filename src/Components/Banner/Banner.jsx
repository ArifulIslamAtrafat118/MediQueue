...
function Banner() {
  return (
    <div 
    className='mt-10 border-4 rounded-2xl px-14 lg:px-[10rem] py-14 border-white shadow-[5px_5px_5px_5px_rgba(245,235,250,0.3)]  bg-gray-100 space-y-8 flex flex-col text-center'
    >
